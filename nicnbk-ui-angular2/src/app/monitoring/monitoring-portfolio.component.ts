...
export class MonitoringPortfolioComponent extends GoogleChartComponent {
    ...
    private nav = [
        ...
        ["Jan-17",812090177,559897597,252192580,74316457,148013133,146142],
        ["Feb-17",814963819,555892063,259071756,80136212,148947147,194682],
        ["Mar-17",815184627,550358874,264825752,83365166,148709389,2848148],
        ["Apr-17",817411061,538901091,278509970,98665606,149694790,137571]
    ];
    ...
    private performance = [
        ...
        ["Mar-17","MTD",0.000270942,0.000839752,-0.002653482,-0.000718493,-0.011191764,0.000000000,-0.000045934,0.015874489,0.000654574,0],
        ...
        ["Apr-17","MTD",0.002531181,0.001813274,0.001608921,0.005211644,0.004022214,0.000000000,0.000754661,0.000000000,0.005645153,0],
    ...
    private publicMarketsPerformance = [
            ...
            ["Apr-17",0.00909122,0.01326543,0.00000000,0.00000000],
    ];
