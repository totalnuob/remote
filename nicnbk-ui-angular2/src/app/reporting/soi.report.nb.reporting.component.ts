...
@Component({
    selector: 'soi.report.nb.reporting',
    templateUrl: 'view/soi.report.nb.reporting.component.html',
    styleUrls: [],
    providers: [],
})
export class SOIReportNBReportingComponent extends CommonNBReportingComponent {
        ...
        this.sub = this.route
            ...
            .subscribe(params => {
                ...
                if(this.reportId > 0){
                    ...
                    this.busy = this.periodicReportService.getSOIReport(this.reportId)
                        .subscribe(
                            response  => {
