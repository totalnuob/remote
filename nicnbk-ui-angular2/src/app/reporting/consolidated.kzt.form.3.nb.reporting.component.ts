...
@Component({
    selector: 'consolidated-kzt-form-3-nb-reporting',
    templateUrl: 'view/consolidated.kzt.form.3.nb.reporting.component.html',
    styleUrls: [],
    providers: [],
})
export class ConsolidatedKZTForm3NBReportingComponent extends CommonNBReportingComponent implements OnInit {
        ...
        this.sub = this.route
            ...
            .subscribe(params => {
                ...
                if(this.reportId > 0){
                    ...
                    this.busy = this.periodicReportService.getConsolidatedKZTForm3(this.reportId)
                        .subscribe(
                            response  => {
                                if(response){
                                    if (response.status === 'FAIL') {
                                        ...
                                        if(this.errorMessage == null){
                                            this.errorMessage = "Error loading KZT Form 3";
                                        }
    ...
    export() {
        this.busyExport = this.periodicReportService.makeFileRequest(DATA_APP_URL + `periodicReport/export/${this.reportId}/${'KZT_FORM_3'}`, 'ОПСД-3')
            .subscribe(
                response  => {
                    //console.log("ok");
                },
