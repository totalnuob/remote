...
@Component({
    selector: 'consolidated-kzt-form-2-nb-reporting',
    templateUrl: 'view/consolidated.kzt.form.2.nb.reporting.component.html',
    styleUrls: [],
    providers: [],
})
export class ConsolidatedKZTForm2NBReportingComponent extends CommonNBReportingComponent implements OnInit {
        ...
        this.sub = this.route
            ...
            .subscribe(params => {
                ...
                if(this.reportId > 0){
                    ...
                    this.busy = this.periodicReportService.getConsolidatedKZTForm2(this.reportId)
                        .subscribe(
                            response  => {
                                if(response){
    ...
    export() {
        this.busyExport = this.periodicReportService.makeFileRequest(DATA_APP_URL + `periodicReport/export/${this.reportId}/${'KZT_FORM_2'}`, 'ОПИУ-2')
            .subscribe(
                response  => {
                    //console.log("ok");
                },
