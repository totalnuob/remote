...
@Component({
    selector: 'terra-generated-form-view-nb-reporting',
    templateUrl: 'view/terra.generated.form.view.nb.reporting.component.html',
    styleUrls: [],
    providers: [],
})
export class TerraGeneratedFormViewNBReportingComponent extends CommonNBReportingComponent implements OnInit {
