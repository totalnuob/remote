...
@Entity
@Table(name="monitoring_hf_contribution_to_return")
public class MonitoringHedgeFundContributionToReturn extends CreatorBaseEntity implements TypedEntity<MonitoringHedgeFundClassType> {
