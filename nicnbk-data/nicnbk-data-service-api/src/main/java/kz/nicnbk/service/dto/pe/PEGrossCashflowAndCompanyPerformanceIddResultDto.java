 ...
 */
public class PEGrossCashflowAndCompanyPerformanceIddResultDto extends PEGrossCashflowResultDto {

    private List<PECompanyPerformanceIddDto> performanceIddDtoList;

    public PEGrossCashflowAndCompanyPerformanceIddResultDto(List<PECompanyPerformanceIddDto> performanceIddDtoList, List<PEGrossCashflowDto> cashflowDtoList, StatusResultType status, String messageRu, String messageEn, String messageKz) {
