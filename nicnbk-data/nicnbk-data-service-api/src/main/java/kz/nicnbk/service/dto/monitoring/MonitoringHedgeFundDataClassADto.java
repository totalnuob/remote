 ...
 */
public class MonitoringHedgeFundDataClassADto implements BaseDto{
    ...
    List<MonitoringHedgeFundTopFundInfoDto> positiveContributors;
    ...
    public List<MonitoringHedgeFundTopFundInfoDto> getPositiveContributors() {
        return positiveContributors;
    }

    public void setPositiveContributors(List<MonitoringHedgeFundTopFundInfoDto> positiveContributors) {
        this.positiveContributors = positiveContributors;
    }

    public List<MonitoringHedgeFundTopFundInfoDto> getNegativeContributors() {
        return negativeContributors;
    }

    public void setNegativeContributors(List<MonitoringHedgeFundTopFundInfoDto> negativeContributors) {
