...
INSERT INTO rep_pe_cashflows_type(id, code, name_en, name_ru, name_kz, parent_id) VALUES(51, 'ADJ_RECON', 'Adjustments to reconcile net increase (decrease) in partner''s capital resulting from operations to net cash used in operating activities', '', '', 1);
